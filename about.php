            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <div class="servers-icon">
                        <img src="images/ant-s9.png" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="head-content">
                        <h4>Our Miners</h4>
                        <p>Antminer ASIC miners are secure, reliable
                            &amp; have amazing performance.</p>

                        <p>Enjoy the peace of mind that comes with owning a quality product.
                        </p>
                    </div>
                </div>
            </div>
...
<div id="ifeatures" class="container-fluid sfeatures">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row-title grey-color">Antminer ASIC Miner Features</div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="feature-box">
                    ...
                    <div class="feature-title">Fast, Secure Shipping</div>
                    <div class="feature-details">From our facility to your doorstep</div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="feature-box">
                    ...
                    <div class="feature-title">Minimal Configuration</div>
                    <div class="feature-details">Start earning right away</div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="feature-box">
                    ...
                    <div class="feature-title">Automated Deposits</div>
                    <div class="feature-details">All earning fill up your wallet automatically </div>
                </div>
            </div>
        </div>
    </div>
...
<!-- <div id="more-info" class="container-fluid darkbg">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="links-holder">
                    <ul>
                        <li><div class="info-link opened" data-id="1">Excellence.</div></li>
                        <li><div class="info-link" data-id="2">High Server Performance</div></li>
                        <li><div class="info-link" data-id="3">Great Support</div></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
...
dolores et quas molestias.</p>
                        ...
                        <div class="person-title">Brian Steve, CEO at Airbnb</div>
                    </div>
                    <div class="info-details info-d2">
                        <h1>Sustainable Hosting</h1>
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus
qui blanditiis praesentium voluptatum div atque corrupti quos
dolores et quas molestias.</p>
                        <div class="photo">
