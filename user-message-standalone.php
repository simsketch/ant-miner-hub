              ...
              <td>
                        <div class="col-md-12">
                            <div class="htfy-pricing-table-holder">
                                <table border="1" id="cart" style="border-collapse:collapse">
                                    <tr>
                                        <th></th>
                                        <th>Item</th>
                                        <th>Qty</th>
                                    ...
                                    for ($i = 0; $i < count($items); $i++) {
                                      if ($cart->$items[$i]->qty > 0) {
                                          $userMessage .= '<tr><td><img src="'.$imgUrl.$items[$i].'.png" style="width:100px"/></td><td>'.$items[$i].'</td><td>'.$cart->$items[$i]->qty.'</td><td>'.$cart->$items[$i]->description.'</td><td>'.$cart->$items[$i]->price.'</td>';
                                        }
                                    }
