                  ...
                  <td width="560" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                    <tbody> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="left" style="padding:0;Margin:0;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, "helvetica neue", helvetica, sans-serif;line-height:150%;color:rgb(51, 51, 51);">Your order has been received and once payment has been received at the specified address, we will ship out your rig(s). You can check your deposit status and order status in one convenient place by clicking the <a href="'.$theUrl.'status.php?transactionid='.$GLOBALS['depositAddress'].'" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none !important;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, "helvetica neue", helvetica, sans-serif;font-size:18px;border-style:solid;border-color:rgb(30, 46, 79);border-width:10px 20px 10px 20px;display:inline-block;background:rgb(30, 46, 79);border-radius:30px;font-weight:normal;font-style:normal;line-height:120%;width:auto;text-align:center;">Check order status</a> button or by scanning the QR code below. Email <a href="info@antminerhub.com">info@antminerhub.com</a> if you have any questions and we will promptly respond.</p></td> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" class="es-p10" style="padding:10px;Margin:0;"> <span class="es-button-border" style="border-style:solid;border-color:rgb(218, 230, 255);background:rgb(218, 230, 255);border-width:10px;display:inline-block;border-radius:30px;width:auto;"> <a href="'.$theUrl.'status.php?transactionid='.$GLOBALS['depositAddress'].'" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none !important;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, "helvetica neue", helvetica, sans-serif;font-size:18px;border-style:solid;border-color:rgb(218, 230, 255);border-width:10px 20px 10px 20px;display:inline-block;background:rgb(218, 230, 255);border-radius:30px;font-weight:normal;font-style:normal;line-height:120%;width:auto;text-align:center;">Check order status</a> </span> </td> 
                     </tr> 
                     </tr> 
                     <tr style="border-collapse:collapse;text-align:center;">
                     <td>
          <img src="https://chart.googleapis.com/chart?chs=125x125&chld=L|0&cht=qr&chl='.$GLOBALS['currency'].':'.$GLOBALS['depositAddress'].'?amount='.$GLOBALS['depositAmount'].'%26label=antminerhub.com%26message=antminerhub.com transaction" />
                     </td>
                     </tr>
                    </tbody> 
                   </table> </td> 
              ...
              <td>
                        <div class="col-md-12">
                            <div class="htfy-pricing-table-holder">
                                <table border="1" id="cart" cellpadding="1" cellspacing="1" width="100%" style="border-collapse:collapse;text-align:center;">
                                    <tr>
                                        <th></th>
                                        <th>Item</th>
                                        <th>Qty</th>
                                    ...
                                    for ($i = 0; $i < count($items); $i++) {
                                      ...
                                      if ($currentItem != "total") {
                                        if ($cart->$currentItem->qty > 0) {
                                            $userMessage .= '<tr><td><img src="'.$imgUrl.$currentItem.'.png" style="width:100px"/></td><td>'.$currentItem.'</td><td>'.$cart->$currentItem->qty.'</td><td>'.$cart->$currentItem->description.'</td><td>'.$cart->$currentItem->price.'</td>';
                                          }
                                      }
                                    }
                                    $userMessage .= '<tr><td>Total</td><td></td><td></td><td></td><td>'.$query['total'].'</td></tr>
                                </table>
                            </div>
                        </div>
                </td>
